//This file runs TestTubeGenerator.cxx
int generateTubeData(Int_t iJob = 0, TString inputFolder = "./") {
  ...
  TestTubeGenerator *test = new TestTubeGenerator();
 // test->SetFileName("../../data_new/dataMom" + suffix + ".csv");
  fRun->AddTask(test);
