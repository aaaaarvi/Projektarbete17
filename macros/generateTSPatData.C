//This file runs TSPatDataGenerator.cxx
int generateTSPatData(Int_t iJob = 0, TString inputFolder = "./") {
  ...
  TSPatDataGenerator *test = new TSPatDataGenerator();
  test->SetFileName("../../data_new/dataTSPat" + suffix + ".csv");
  fRun->AddTask(test);
