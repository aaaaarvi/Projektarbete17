//This file runs ClassDataGenerator.cxx
int generateClassData(Int_t iJob = 0, TString inputFolder = "./") {
  ...
  ClassDataGenerator *test = new ClassDataGenerator();
  test->SetFileName("../../data_new/dataClass" + suffix + ".csv");
  fRun->AddTask(test);
