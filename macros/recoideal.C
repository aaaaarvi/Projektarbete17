int recoideal(Int_t iJob = 0, TString folder = "../../data_new/")
{
  ...
  // TString folder = "/shared/data/";
  TString suffix = "";
  suffix.Form("_%i",iJob);

  // Parameter file
  TString parFile = folder + "/" + "par" + suffix + ".root"; // at the moment you do not need it
  
  // Digitisation file (ascii)
  TString digiFile = "all.par";
  
  TString sim = folder + "/" + "sim" + suffix + ".root";
  TString digi = folder + "/" + "digi" + suffix + ".root";

  // Output file
  TString outFile = folder + "/" + "recoideal" + suffix + ".root";
